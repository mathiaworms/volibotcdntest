    ...
    var e = window,
        ...
        a = Riot.DDragon = {
            ...
            rd: function() {
                var c = !1;
                if (a.ls)
                    if (a.rdd = g.getItem("rg_ddragon_override"), null !== a.rdd) c = !0;
            ...
            switch (typeof f) {
                ...
                case "object":
                    ...
                    if (l && "object" === typeof l) {
                        ...
                        for (m in f) Object.prototype.hasOwnProperty.call(f, m) && (k = e(m, f)) && j.push(b(m) + (i ?
                            ": " : ":") + k);
                    k = 0 === j.length ? "{}" : i ? "{\n" + i + j.join(",\n" + i) + "\n" + q + "}" : "{" + j.join(",") + "}";
                    i = q;
                    return k
        ...
        if ("function" !== typeof n.parse) n.parse = function(a, b) {
            function c(a, d) {
                ...
                if (f && "object" === typeof f)
                    for (e in f) Object.prototype.hasOwnProperty.call(f, e) && (h = c(f, e), void 0 !== h ? f[e] = h : delete f[e]);
                return b.call(a, d, f)
            }
            var e, a = "" + a;
            d.lastIndex = 0;
